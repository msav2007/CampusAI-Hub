    ...
    return (
      <div className="space-y-3">
                ...
                {onReorder && (
                  <>
                    ...
                    <Button
                      ...
                      className="h-8 w-8 text-muted-foreground hover:text-foreground"
                      onClick={() => onReorder(i, 1)}
                      disabled={i === value.length - 1 || isLoading}
                    >
                      <span className="text-lg leading-none">↓</span>
                    </Button>
                  </>
        ...
        {maxFiles > 1 && value.length < maxFiles && (
          <div
            {...getRootProps()}
            className="cursor-pointer border-2 border-dashed border-border/60 rounded-xl p-4 text-center hover:bg-surface-2/30 transition-colors"
          >
            <input {...getInputProps()} />
  ...
  return (
    <div className="space-y-2">
      ...
      >
        ...
        <Upload
          className={`h-8 w-8 mb-4 ${isDragActive ? "text-brand" : "text-muted-foreground"}`}
        />

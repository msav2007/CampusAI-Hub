...
export const Route = createFileRoute("/tools/resume-ats")({
  head: () => ({
    ...buildPageHead({
      ...
      description:
        "Upload your resume, paste a job description, and get a realistic ATS score with detailed category feedback.",
          ...
          <div className="flex items-center justify-between gap-3 mb-6">
            ...
            {analysis && (
              <div className="flex gap-2">
                <Button variant="outline" size="icon" onClick={copyReport} title="Copy Report">

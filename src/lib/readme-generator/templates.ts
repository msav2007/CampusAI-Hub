...
const baseTemplate: ReadmeInput = {
  ...
  githubRepo: "",
  badges: {
    react: false, typescript: false, license: true, version: false, build: false,
    next: false, vite: false, node: false, python: false, javascript: false,
  },
  features: [],
  ...
  screenshots: [],
  advancedSections: {
    toc: true, folderStructure: true, envVars: false, apiDocs: false,
    usageExamples: true, roadmap: true, contributing: true, license: true, author: true,
  },
  licenseType: "MIT",
...
export const TEMPLATES: Record<string, ReadmeInput> = {
  "react": {
    ...
    detailedDescription: "This project provides a beautiful, responsive, and highly optimized UI for modern users. Built with Vite and React, it ensures instant HMR and tiny bundle sizes.",
  ...
  "fullstack": {
    ...
    detailedDescription: "This project contains a complete end-to-end stack for building a SaaS product, complete with authentication, a database, and a fully featured API.",
  ...
  "ai": {
    ...
    detailedDescription: "A powerful backend wrapper around modern LLMs. It handles prompt engineering, context chunking, and streaming responses back to the client.",
  ...
  "library": {
    ...
    detailedDescription: "Stop wasting time writing boilerplate. This zero-dependency library provides the ultimate set of functions for handling complex data structures efficiently.",
    ...
    techStack: {
      ...
      backend: [], database: [], tools: ["GitHub Actions"]
    },
    advancedSections: { ...baseTemplate.advancedSections, usageExamples: true, folderStructure: false },
  }
};
